...
export function Header() {
  ...
  const iconBtnClass = "flex h-9 w-9 sm:h-10 sm:w-10 items-center justify-center rounded-full border border-white/40 bg-white/70 text-neutral-800 backdrop-blur-xl transition-[box-shadow,color,background-color,border-color] duration-300 ease-out group-hover:bg-white/90 group-hover:shadow-[0_22px_45px_-10px_rgba(0,0,0,0.1),inset_0_1px_0_rgba(255,255,255,0.8)] active:shadow-inner focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-emerald-500/70 dark:border-white/[0.12] dark:bg-white/[0.08] dark:text-neutral-200 dark:backdrop-blur-xl dark:group-hover:bg-white/[0.14] dark:group-hover:border-white/[0.18] dark:group-hover:text-emerald-50 dark:group-hover:shadow-[0_25px_50px_-12px_rgba(0,0,0,0.7),inset_0_1px_0_rgba(255,255,255,0.06)] dark:active:shadow-[inset_0_3px_8px_rgba(0,0,0,0.3)]";

  const navLinkClass = (sectionId: string) => {
    const isActive = activeSection === sectionId;
    return `rounded-full px-4 py-2 text-sm font-medium transition-all duration-200 focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-emerald-500/70 focus-visible:ring-offset-2 ${
      isActive
