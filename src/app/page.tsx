  ...
  return (
    <>
      ...
      <main className="relative flex min-h-screen flex-col antialiased subpixel-antialiased selection:bg-emerald-500/20 w-full overflow-x-hidden">
        ...
        <section id="progetti" className="relative px-6 py-28 md:px-12 lg:px-24 overflow-hidden">
          ...
          <div className="mx-auto max-w-6xl w-full">
            <div className="mb-24 max-w-2xl">
              <span className="text-xs font-semibold uppercase tracking-[0.25em] text-emerald-600 dark:text-emerald-400 block mb-2.5">
                Selected Works
              </span>
              ...
              >
                <div className="w-full lg:w-[45%] flex flex-col justify-between space-y-6">
                  <div className="space-y-4">
                    ...
                    <p className="text-sm sm:text-base leading-relaxed text-neutral-600 dark:text-neutral-400 font-normal">
                      ...
                      <span className="block mt-3 p-3 bg-neutral-50 dark:bg-white/[0.02] border border-neutral-100 dark:border-white/[0.04] rounded-xl text-xs italic text-neutral-500 dark:text-neutral-400 shadow-sm">
                    ...
                    <ul className="text-xs text-neutral-500 dark:text-neutral-400 space-y-2.5 list-none pl-1 font-medium">
                  ...
                  <div className="space-y-4 pt-2">
                    <div className="flex flex-wrap gap-1.5">
                      {["Assembly x86", "Python", "Raspberry Pi", "AutoCAD", "Linux Embedded"].map((tech) => (
                        <span key={tech} className="rounded-full border border-neutral-200/60 bg-white/50 px-2.5 py-0.5 text-xs font-medium text-neutral-600 dark:border-white/5 dark:bg-white/[0.04] dark:text-neutral-300 shadow-[0_1px_2px_rgba(0,0,0,0.01)]">
                          {tech}
                        </span>
                      ))}
                    </div>
                ...
                <div className="w-full lg:w-[55%] relative group/canvas">
                  ...
                  <SpotlightCard className="w-full overflow-hidden rounded-2xl border border-neutral-200/80 dark:border-white/10 shadow-[0_20px_50px_rgba(0,0,0,0.05)] dark:shadow-[0_30px_60px_rgba(0,0,0,0.4)] backdrop-blur-md bg-white/40 dark:bg-neutral-900/40 p-4">
                    ...
                    <div role="tablist" className="grid grid-cols-2 sm:flex sm:flex-row gap-1 bg-neutral-100/80 dark:bg-neutral-950 p-1 rounded-xl border border-neutral-200/50 dark:border-white/5 shadow-inner mb-4 relative z-20">
                      {projectTabs.map((tab) => {
                        ...
                        return (
                          <button
                            ...
                            role="tab"
                            className={`relative w-full sm:flex-1 flex items-center justify-center py-2 text-xs rounded-lg transition-colors duration-300 focus-visible:outline-none ${isActive
                    ...
                    <div 
                      ...
                      tabIndex={0}
                      className="min-h-[320px] sm:min-h-[350px] bg-gradient-to-b from-neutral-900 to-neutral-950 rounded-xl border border-neutral-950 p-5 font-mono text-sm relative flex flex-col justify-between shadow-inner overflow-hidden z-10"
                    >
                          ...
                          {activeTab === "benchmark" && (
                            <div className="h-full flex flex-col justify-between py-1 gap-4">
                              <div className="flex items-center justify-between border-b border-white/5 pb-2">
                                ...
                                <button type="button" onClick={runBenchmark} disabled={isBenchmarking} className="flex items-center gap-1 bg-emerald-400 hover:bg-emerald-500 disabled:bg-neutral-800 text-neutral-950 disabled:text-neutral-500 text-xs font-bold px-2.5 py-1 rounded-lg transition-all font-sans">
                  ...
                  <SpotlightCard className="w-full overflow-hidden rounded-2xl border border-neutral-200/80 dark:border-white/10 shadow-[0_20px_50px_rgba(0,0,0,0.05)] dark:shadow-[0_30px_60px_rgba(0,0,0,0.4)] backdrop-blur-md bg-white/40 dark:bg-neutral-900/40 p-5 min-h-[420px] sm:min-h-[460px] flex flex-col justify-center items-center relative">
                    ...
                    {nfcState === "idle" && (
                      <div className="z-10 flex flex-col items-center gap-5 text-center animate-fade-in w-full px-2">
                        ...
                        <p className="text-xs sm:text-sm text-black-400 font-sans font-medium mt-2 animate-pulse">
                    ...
                    {nfcState === "showing" && (
                      <div className="z-10 w-full h-full flex flex-col items-center justify-center animate-fade-in relative group max-w-[260px] sm:max-w-[300px]">
                        ...
                        <button
                          ...
                          className="absolute bottom-3 right-3 flex items-center gap-1.5 bg-neutral-950/90 hover:bg-neutral-900 backdrop-blur-md border border-white/10 text-neutral-300 px-3 py-1.5 rounded-full text-xs font-mono transition-all shadow-md active:scale-95"
                        >
